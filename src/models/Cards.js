...
class Cards extends MongoBase {
    ...
    async create(data, deviceInfo = {}) {
        ...
        const record = {
            ...
            settlement_delay: data.settlement_delay || 1800,
        ...
        //check if any card has status as pending_deployment or deploying for the user. if yes override existing dont create another one
